<div align="center">
  ...
  <h2 align="center">Erciyes Bootcamp Product Router</h2>

  <p align="center">

   A Product Router project that I built with ReactJS + Vite ⚡️ <br/> Built with [Bun](https://bun.sh/) with ❤️ by [Yamisagi](https://wwwç.linkedin.com/in/yamisagi/).
...
- [x] Create Home & Table Components with TailwindCSS
- [x] Create Product & ProductDetail Components with TailwindCSS
- [x] Add ProductDataContext and useProductData Custom Hook
- [x] Update AppRouter and Navbar Component.
- [x] Implement Slug in Routes 
- [x] Fix Navigation Issue for null ID
- [x] Finish Project 🎉
- [x] Deploy Project 🚀
